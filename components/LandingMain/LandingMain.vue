  ...
  <main>
    <div class="flex flex-row justife-between px-20 pt-12 pb-16">
      ...
      <div class="flex flex-row pt-64 z-50">
        <img :src="require('@/static/img/info-country.svg')" alt="" />
    ...
    <div class="flex flex-col text-white px-20 pt-12 pb-28">
      ...
      <div class="grid grid-cols-3 gap-6 z-50">
        ...
        />
        <div
          class="flex justify-between grid-text border-b-2 border-lightgreen pb-2"
        >
          <button @click="currentWeight -= 0.5">
            <img :src="require('@/static/img/subtraction.svg')" alt="" />
          </button>
          <p>{{ currentWeight }} кг</p>
          <button @click="currentWeight += 0.5">
            <img :src="require('@/static/img/sum.svg')" alt="" />
          </button>
        </div>
        ...
        />
        <div
          class="flex justify-between grid-text border-b-2 border-lightgreen"
        >
          <input class="bg-transparent w-80" />
          <img :src="require('@/static/img/akar-icons_pencil.svg')" alt="" />
        </div>
        <div class="flex justify-between items-center">
          <p class="font-bold text-lg leading-5">Пункт выдачи</p>
          <p class="font-bold text-lg leading-5">0 дней</p>
          <p class="font-bold text-3xl leading-10">0 $</p>
        </div>
        <div class="flex justify-between items-center">
        ...
        <p class="text-mass font-bold text-lg leading-5">
          Примерный объемный вес посылок
        </p>
      </div>
    </div>
    ...
    <div class="forwarding-main-text flex gap-56 px-20 mb-40">
      ...
      <div class="flex flex-col w-1/2 z-50">
        ...
        <div v-for="item in mainForwarding" :key="item.id">
          <p
            class="forwarding-main-info font-normal text-xl leading-7 mb-6"
            v-html="item.title"
          ></p>
        </div>
        <div class="mt-14">
...
export default {
  ...
  data: () => ({
    ...
    mainForwarding: [
      ...
      {
        title:
          'Посылки летят из США, Европы и Японии, проходят таможенное оформление и доставляются по всей России до пунктов выдачи или до двери курьером по Вашему желанию.',
      },
      {
      ...
      {
        title:
          'Отследить посылку после отправки по номеру заказа можно на сайте <a href="#" style="color: #00833E; text-decoration-line: underline;">PONY EXPRESS</a>',
      },
      {
        title:
          '<a href="#" style="color: #00833E; text-decoration-line: underline;">Условия доставки</a>',
      },
      {
        title:
          '<a href="#" style="color: #00833E; text-decoration-line: underline;">Ограничения по услуге</a>',
      },
      {
        title:
          '<a href="#" style="color: #00833E; text-decoration-line: underline;">Информация по лимитам беспошлинного ввоза</a>',
      },
      {
        title:
          '<a href="#" style="color: #00833E; text-decoration-line: underline;">Где находятся пункты выдачи</a>',
      },
    ],
  }),
}
